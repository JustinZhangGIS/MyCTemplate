...
define({
    root: {
        ...
        buttons: {
            ...
            editButtonText:"Edit",//Command button in ‘Activity’  start edit geoplot.(20160101)
        ...
        tooltips: {
            ...
            locateTooltip: "定位", // Shown as a tooltip for Geolocation icon in appHeader.
            shareTooltip: "共享", // Shown as a tooltip for Share icon in appHeader to open the options available to share the application.
            helpTooltip: "帮助", // Shown as a tooltip for Help icon in appHeader to view the help file.
            eventsTooltip: "My List", // Shown as a tooltip for My List icon in appHeader to view My List items.
            chartsTip: "图表", // Shown as a tooltip for My List icon in appHeader to view My List items.
            layerListtip: "图层控制", // Shown as a tooltip for My List icon in appHeader to view My List items.
            ...
            search: "查询", // Shown as a tooltip for Search button icon next to Clear icon in unified search textbox to search the specified address.
            geoplot: "标绘", // Shown as a tooltip for Search button icon next to Clear icon in unified search textbox to search the specified address.
        ...
        titles: {
            ...
            activityChartsTabName: "图表", // Shown as a title when My List tab is clicked/tapped.
            activitySearchTabName: "查询", // Shown as a title when My List tab is clicked/tapped.
            arraysListTabName: "图层控制", // Shown as a title when My List tab is clicked/tapped.
