    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, ActivityGeoplot, EventPlannerHelper], {
        ...
        */
        postCreate: function () {
            ...
            domStyle.set(this.divSearchPanel, "display", "none");
            /**
            ...
            */
            ...
            this.domNode = domConstruct.create("div", { "title": sharedNls.tooltips.geoplot, "class": "esriCTHeaderGeoplot" }, null);
            ...
            this.own(on(this.domNode, a11yclick, lang.hitch(this, function () {
                ...
                */
                ...
                topic.publish("toggleWidget", "geoPlotSetting");
                if (win.getBox().w <= 766) {
            ...
            // click on "buttonEdit" button in activity search
            this.own(on(this.buttonEdit, a11yclick, lang.hitch(this, function () {
