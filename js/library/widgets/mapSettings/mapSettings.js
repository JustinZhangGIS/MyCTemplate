    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        */
        postCreate: function () {
            ...
            //wfh   20151224  通用查询的弹窗
            topic.subscribe("showInfoWindowOnMapNew", lang.hitch(this, function (mapPoint, featureArray) {
                if (featureArray.length > 0) {
                    ...
                    this.infoWindowHelperObject._createInfoWindowContentNew(infoWindowParameter);
                } else {
                    //topic.publish("hideProgressIndicator");
                }
            }));
            ...
            */
            ...
            if (appGlobals.configData.WebMapId && lang.trim(appGlobals.configData.WebMapId).length !== 0) {
                ...
                mapDeferred.then(lang.hitch(this, function (response) {
                    ...
                    dojo.mapResponse = response;//wfh 20151211
        ...
        */
        _mapEvents: function () {
            ...
            this.own(on(this.map, a11yclick, lang.hitch(this, function (evt) {
                //topic.publish("removeGeolocationPushPin");//20160106
                topic.publish("removeLocatorPushPin");//20160106 ok 清除 闪烁的图片
        ...
        */
        _showInfoWindowOnMap: function (mapPoint, featureOf) {
            ...
            all(onMapFeaturArray).then(lang.hitch(this, function (result) {//进到这个函数里面就   关掉下拉菜单了  也没找到代码。
                var j, i;
                if (result) {
