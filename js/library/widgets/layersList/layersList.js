...
define([
    ...
    "dojo/dom-style",
    "dojo/date/locale",
    "dojo/text!./templates/layersListTemplate.html",
    "dojo/window",
    "dijit/_WidgetBase",
...
], function (declare, domConstruct, lang, on, dom, domAttr, domClass, html, domStyle, locale, template, win, _WidgetBase,
             _TemplatedMixin, _WidgetsInTemplateMixin, sharedNls, topic, date, Point, array, string, query, a11yclick, MyListHelper,
        ...
        */
        postCreate: function () {
            ...
            */
            ...
            this.domNode = domConstruct.create("div", { "title": sharedNls.tooltips.layerListtip, "class": "esriCTlayersList" }, null);
            ...
            // Subscribing to store feature set searched from event search in eventPlannerHelperNewTemp.js file.
            ...
            */
            ...
            // Function to show myList container on click.
                // wfh
            //wfh start 图层控制
            var layersDiv = dom.byId("layersDiv");
            var toc = new LayerList({
                //map: dojo.mapTemp,
                //map: dojo.response.map,
                map: dojo.mapResponse.map,
                showSubLayers: true,
                subLayers: true,
                showLegend: true,
                showOpacitySlider: true,
                //layers: arcgisUtils.getLayerList(dojo.response) //我也是醉了 名字都抄不对！ mapResponse
                layers: arcgisUtils.getLayerList(dojo.mapResponse)
        ...
        */
        _showMyListContainer: function () {
            ...
            if (html.coords(this.applicationHeaderActivityContainer).h > 1) {
                ...
                */
                //domClass.replace(this.domNode, "esriCTlayersListSelected", "esriCTlayersList");
